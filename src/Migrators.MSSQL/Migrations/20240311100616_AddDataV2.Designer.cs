...
namespace Migrators.MSSQL.Migrations
{
    ...
    [Migration("20240311100616_AddDataV2")]
    partial class AddDataV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entitites.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Bio = "Tôi là là một thiết kế UI/UX đam mê và sáng tạo, đã tham gia vào nhiều dự án thành công trong lĩnh vực công nghệ.",
            ...
            modelBuilder.Entity("Domain.Entitites.Follow", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FollowerId = new Guid("00000000-0000-0000-0000-000000000002")
                        },
                        new
                        {
                            AccountId = new Guid("00000000-0000-0000-0000-000000000003"),
                            FollowerId = new Guid("00000000-0000-0000-0000-000000000005")
                        });
                });
