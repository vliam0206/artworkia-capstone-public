...
public class TagConfiguration : IEntityTypeConfiguration<Tag>
{
    public void Configure(EntityTypeBuilder<Tag> builder)
    {
        ...
        (
            ...
            new Tag() { Id = Guid.Parse("00000000-0000-0000-0000-00000000000e"), TagName = "Chủ đề xã hội" },
            ...
            new Tag() { Id = Guid.Parse("00000000-0000-0000-0000-000000000011"), TagName = "Minimalism" },
            ...
            new Tag() { Id = Guid.Parse("00000000-0000-0000-0000-000000000014"), TagName = "Động vật hoang dã" },
            new Tag() { Id = Guid.Parse("00000000-0000-0000-0000-000000000015"), TagName = "Nền tảng" },
            new Tag() { Id = Guid.Parse("00000000-0000-0000-0000-000000000016"), TagName = "Nghệ thuật đương đại" },
            new Tag() { Id = Guid.Parse("00000000-0000-0000-0000-000000000017"), TagName = "Chủ đề khoa học" },
            new Tag() { Id = Guid.Parse("00000000-0000-0000-0000-000000000018"), TagName = "Giao thông" }
        );
        #endregion
    }
}
